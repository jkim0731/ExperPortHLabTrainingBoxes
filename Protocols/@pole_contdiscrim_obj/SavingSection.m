...
% 
      ...
      MenuParam(obj, 'HeadFixed', {'Fixed w/o anesthesia','Fixed after anesthesia','Not fixed'},'Fixed w/o anesthesia', x, y); next_row(y);
      ...
      MenuParam(obj, 'WhiskerSet', {'Full','C2 only','None','Row C only'},'C2 only', x, y); 
      next_row(y, 1);

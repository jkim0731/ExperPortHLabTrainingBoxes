function [obj] = pole_2port_angdistobj(name)
...
%SoloFunctionAddVars('CoolButton'
...
SoloParamHandle(obj, 'pole_distance_history', 'value', []);
SoloParamHandle(obj, 'pole_ap_position_history', 'value', []);
SoloParamHandle(obj, 'pole_angle_history', 'value', []);
...
DeclareGlobals(obj, 'ro_args', {'n_done_trials', 'n_started_trials', ...
                    'hit_history', 'pole_ap_position_history', 'pole_distance_history', 'pole_angle_history', 'pole_position_list',...
...
SoloFunctionAddVars('MotorsSection', 'rw_args', 'pole_distance_history');
SoloFunctionAddVars('MotorsSection', 'rw_args', 'pole_ap_position_history');
SoloFunctionAddVars('MotorsSection', 'rw_args', 'pole_angle_history');
...
SoloParamHandle(obj, 'trial_finished_actions', 'value', { ...
  ...
  'MotorsSection(obj, ''move_next_side'');'              ; ... % 6th
...
% (Every 100 ms or so, the RPbox.m module polls the RT machine to ask for
